package org.example.ray.infrastructure.spi;
 ...
 * @author zhoulei
 * @create 2023/5/17
 * @description: refer to dubbo spi:
...
public final class ExtensionLoader<T> {
    ...
    private T createExtension(String name) {
        // load all extension classes of type T from file and get specific one
        // by name
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.length() > 0) {
                    try {
                        ...
                        // our SPI use key-value pair so both of them must not
                        // be empty
